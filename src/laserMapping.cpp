...
void publish_frame_body(const ros::Publisher &pubLaserCloudFull_body) {
  ...
  laserCloudmsg.header.stamp = ros::Time().fromSec(lidar_end_time);
  laserCloudmsg.header.frame_id = "base_slam";
...
void publish_odometry(const ros::Publisher &pubOdomAftMapped) {
  ...
  odomAftMapped.child_frame_id = "base_slam";
  ...
  br.sendTransform(tf::StampedTransform(transform, odomAftMapped.header.stamp,
                                        "slam_estimator_world", "base_slam"));
}
...
int main(int argc, char **argv) {
  ...
  ros::Publisher pubLaserCloudMap =
      nh.advertise<sensor_msgs::PointCloud2>("/Laser_map", 1000);
